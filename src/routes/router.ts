...
route.get("/notice_board", findNotice);
...
route.post("/notice_board", createNotice);
route.patch("/notice_board/:id", updateNotice);
route.delete("/notice_board/:id", deleteNotice);
